...
export function Skateboard({
    wheelTextureURL, wheelTextureURLs, deckTextureURL, deckTextureURLs, truckColor, boltColor, constWheelSpin = false
}: SkateboardProps) {
  ...
  const deckTexture = deckTextures[deckTextureIndex]
    ...
    const wheelMaterial = useMemo(
        ...
        useFrame(()=> {
            if(!wheelRefs.current || !constWheelSpin) return
        ...
        }, [constWheelSpin, wheelTextureURL])
